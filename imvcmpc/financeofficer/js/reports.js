...
function setupMemberConfigListeners() {
    ...
    if (memberSearchInput) {
        ...
        let searchTimeout;
        const originalInputHandler = memberSearchInput.oninput;
        memberSearchInput.addEventListener('input', function(e) {
...
function populateMemberYearDropdown() {
    ...
    // Add event listener to clear report when year changes
...
<body>
    <div class="report-header-section">
        ...
        ${window.isPrefillLocked ? `<div class="report-meta"><strong>Submitted to:</strong> Marketing Clerk - ${branchDisplay}</div>` : ''}
